  ...
  const generatePDF = async () => {
    ...
    const printContent = `
      <html>
        ...
        <body>
          <img src="/logo-afri-removebg-preview.png" class="watermark" alt="Watermark" />
          <div class="content">
            ...
            <div class="header-info">
              ${selectedLanguage === 'fr' ? 'Généré depuis' : 'Generated from'}: <a href="afrifek.vercel.app" style="color: #d97706;">afrifek.org</a> | ${new Date().toLocaleDateString()}
            </div>
            <table>
              <thead>
                <tr>
        ...
        <body>
          <div class="content">
            ...
            <div class="footer">
              ...
              <p>For more information: www.afrifek.org | This document is protected and authenticated</p>
            </div>
          </div>
        </body>
      </html>
